...
var endpoint = function endpoint(payload) {
  ...
  var url = (0, _utils.parseUrl)(_url);
  var res = {
    url: url,
    key: key
  };
  ...
  var get = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_query) {
      var config,
          query,
          client,
          _args = arguments;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return client.get((0, _utils.queryUrl)({
                url: url,
                query: query
              }), config).then(function (res) {
                return res.data;
              })["catch"](_utils.catchHandler);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              client = config.axios || _axios["default"];
              _context2.next = 5;
              return client.put((0, _utils.queryUrl)({
                url: url,
                query: query
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              client = config.axios || _axios["default"];
              _context3.next = 5;
              return client.post((0, _utils.queryUrl)({
                url: url,
                query: query
              }), data, config).then(function (res) {
                return res.data;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              client = config.axios || _axios["default"];
              _context4.next = 5;
              return client["delete"]((0, _utils.queryUrl)({
                url: url,
                query: query
              }), _objectSpread({
                data: data
  ...
  if ('GET' in _handler) {
    var createQueryHandler = function createQueryHandler() {
      ...
      return /*#__PURE__*/function () {
        var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(_ref5) {
          var _ref5$queryKey, _key, query;

          return _regeneratorRuntime().wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  _ref5$queryKey = _slicedToArray(_ref5.queryKey, 2), _key = _ref5$queryKey[0], query = _ref5$queryKey[1];
                  _context5.next = 3;
    ...
    var prefetch = function prefetch(params) {
      ...
      return /*#__PURE__*/function () {
        var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(queryClient) {
  ...
  if (_utils.isServer) res['handler'] = handler;

  if (routes && routes.length > 0) {
    routes.forEach(function (r) {
      var key = (0, _utils.capitalize)(r.key);
      res[key] = r;
    });
  } // console.log(res)
